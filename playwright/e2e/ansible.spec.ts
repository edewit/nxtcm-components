...
test.describe('ansible wizard', () => {
  test('complete ansible automation workflow', async ({ page }) => {
    ...
    await installPrehooks.getByRole('button', { name: 'Add job template' }).click();
    ...
    await installPrehook1.locator('.pf-v5-c-form__field-group-toggle .pf-v5-c-button').click();
    ...
    await installPrehook2.locator('.pf-v5-c-form__field-group-toggle .pf-v5-c-button').click();

    // Install posthooks
    const installPosthooks = page.locator('#install-posthooks');
    await installPosthooks.getByRole('button', { name: 'Add job template' }).click();
    ...
    await installPosthook1.locator('.pf-v5-c-form__field-group-toggle .pf-v5-c-button').click();
    ...
    await installPosthook2.locator('.pf-v5-c-form__field-group-toggle .pf-v5-c-button').click();
    ...
    await upgradePrehooks.getByRole('button', { name: 'Add job template' }).click();
    ...
    await upgradePrehook1.locator('.pf-v5-c-form__field-group-toggle .pf-v5-c-button').click();
    ...
    await upgradePrehook2.locator('.pf-v5-c-form__field-group-toggle .pf-v5-c-button').click();

    // Upgrade posthooks
    const upgradePosthooks = page.locator('#upgrade-posthooks');
    await upgradePosthooks.getByRole('button', { name: 'Add job template' }).click();
    ...
    await upgradePosthook1.locator('.pf-v5-c-form__field-group-toggle .pf-v5-c-button').click();
    ...
    await upgradePosthook2.locator('.pf-v5-c-form__field-group-toggle .pf-v5-c-button').click();
