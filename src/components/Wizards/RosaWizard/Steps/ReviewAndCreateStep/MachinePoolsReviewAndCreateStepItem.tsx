...
export const MachinePoolsReviewAndCreateStepItem: React.FunctionComponent<MachinePoolsReviewAndCreateStepItemProps> = ({ machinePools }) => {
    return (
        <Stack hasGutter>
            <StackItem>
                ...
                machinePools.map((machinePool: MachinePoolReviewAndCreateItem) => {
                    return (
                        <StackItem>
                            <Flex justifyContent={{ default: "justifyContentSpaceBetween" }}>
                                <FlexItem>
                                    {machinePool?.availability_zone}
                                </FlexItem>
                                <FlexItem>
                                    {machinePool?.public_subnet}
                                </FlexItem>
                            </Flex>
                        </StackItem>
                    )
