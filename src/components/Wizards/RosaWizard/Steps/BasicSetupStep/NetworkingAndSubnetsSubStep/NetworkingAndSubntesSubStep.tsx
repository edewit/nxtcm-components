...
export const NetworkingAndSubnetsSubStep: React.FunctionComponent<
  NetworkingAndSubnetsSubStepProps
> = ({ publicSubnets, privateSubnets, vpcList }) => {
  return (
    <>
      ...
      >
        ...
        >
          <WizSelect
            ...
            path="metadata.public-private-subnet.private-subnet"
