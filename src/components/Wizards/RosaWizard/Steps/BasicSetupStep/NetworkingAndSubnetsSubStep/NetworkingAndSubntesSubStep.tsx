    ...
    <>
      ...
      <Section label="Machine pools" id="machine-pools-section" key="machine-pools-key">
        <Content component={ContentVariants.p}>
          Create machine pools and specify the private subnet for each machine pool. To allow high
          availability for your workloads, add machine pools on different availablity zones.
        </Content>
        <Content component={ContentVariants.p}>
          The following settings apply to all machine pools created during cluster install.
        ...
        <WizArrayInput
          ...
          collapsedContent={
            <WizTextDetail path="name" placeholder="Expand to edit the machine pool details" />
          }
        >
          <Flex>
            <FlexItem>
