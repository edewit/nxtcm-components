    ...
    return(
        <Section id="cluster-updates-substep-section" key="cluster-updates-substep-section-key" label="Cluster update strategy">
            ...
            <WizRadioGroup path="cluster.upgrade_policy">
                <Radio id="cluster-upgrade-strategy-individual-radio-btn" label="Individual updates" value="automatic"
                ...
                <Radio id="cluster-upgrade-strategy-recurring-radio-btn" label="Recurring updates" value="manual" 
