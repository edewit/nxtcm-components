...
const getProps = (
  items: SampleItem[]
): ConsoleBreadcrumbsProps<SampleItem> => ({
  items,
...
test.describe('ConsoleBreadcrumbs', () => {
  ...
  test('should render breadcrumb navigation with correct structure', async ({
    mount,
    page,
  }) => {
  ...
  test('should render correct number of items for different scenarios', async ({
    mount,
    page,
  }) => {
