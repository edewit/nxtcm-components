...
describe("CVECard", () => {
  ...
  it("should render the default description", () => {
    render(<CVECard cveData={mockCVEData} />);
    expect(
      screen.getByText(/Red Hat recommends addressing these CVEs/i),
    ).toBeInTheDocument();
  });
  ...
  it("should render severity labels correctly", () => {
    render(<CVECard cveData={mockCVEData} />);
    expect(
      screen.getByText("Critical severity CVEs on your associated"),
    ).toBeInTheDocument();
    expect(
      screen.getByText("Important severity CVEs on your associated"),
    ).toBeInTheDocument();
  });
  ...
  it("should apply custom className when provided", () => {
    const { container } = render(
      <CVECard cveData={mockCVEData} className="custom-class" />,
    );
